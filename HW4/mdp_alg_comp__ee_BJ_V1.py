...
def test_frozen_lake():
    ...
    plt.grid(True)
    for i in range(len(x)):
        Q_fl, Q_V_fl, Q_pi_fl, Q_track_fl, Q_pi_track_fl = RL(blackjack_s).q_learning(gamma=.99, epsilon_decay_ratio=.75,
                                                                                    n_episodes=5000,
    ...
    plt.xlabel("Iterations")
    plt.ylabel("V(s)")
    plt.title("Blackjack -Small: Q-Learning - Learning Rate Change")
    ...
    plt.grid(True)
    for i in range(len(x)):
        Q_fl, Q_V_fl, Q_pi_fl, Q_track_fl, Q_pi_track_fl = RL(blackjack_s).q_learning(gamma=.99, epsilon_decay_ratio=x[i],
                                                                                n_episodes=5000,
    ...
    plt.xlabel("Iterations")
    plt.ylabel("V(s)")
    plt.title("Blackjack -Small: Q-Learning - Epsilon Decay")
    ...
    plt.xlabel("Iterations")
    plt.ylabel("V(s)")
    plt.title("Blackjack -Small: Q-Learning - Alpha Decay")
    ...
    plt.xlabel("Iterations")
    plt.ylabel("V(s)")
    plt.title("Blackjack -Small: Q-Learning - Initial Epsilon")
    # plt.savefig("images/FL_VI_Tuning_L_InitialEpsilon.png")
    # plt.show()
    plt.suptitle("Exploration-Exploitation Trade-Off")
    plt.tight_layout()
    plt.savefig("images/BJ_VI_Tuning_L_4_GreedyEpsilon_Exploration.png")
    # plt.show()
