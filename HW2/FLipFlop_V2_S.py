...
def plot_graph_fitness_iterations(title, array1, array2, array3, array4):
    ...
    plt.savefig('images/FlipFlop_Fit_Small.png')
    plt.show()
...
def plot_bar_max_fitness(title, array1, array2, array3, array4):
    ...
    plt.legend()
    plt.savefig('images/FlipFlop_Bar_Small.png')
    plt.show()
...
def plot_bar_max_fitness_iteration(title, array1, array2, array3, array4):
    ...
    plt.ylabel('Max Fitness')
    plt.legend()
    plt.savefig('images/FlipFlop_MaxIteration_Small.png')
    plt.show()
...
def plot_graph_fevals_iterations(title, array1, array2, array3, array4):
    ...
    plt.savefig('images/FLipFlop_FEvals_Small.png')
    plt.show()
...
def plot_clock_time_table(title, array1, array2, array3, array4):
    ...
    table.scale(1.2, 1.2)
    plt.savefig('images/FlipFlop_ClockTime_Small.png')
    plt.show()
...
def test_flipflop():
    ...
    problem = FlipFlopGenerator.generate(seed=7, size=25)
    ...
    """
    plot_graph_fitness_iterations('Fitness vs Iteration: FlipFlop using RHC vs SA vs GA vs MIMIC-Small', array1=fit_rhc,
                                  array2=fit_sa, array3=fit_ga, array4=fit_mimic)
    plot_bar_max_fitness('Max Fitness: FlipFlop using RHC vs SA vs GA vs MIMIC-Small', array1=max(fit_rhc),
                         array2=max(fit_sa), array3=max(fit_ga), array4=max(fit_mimic))
    plot_bar_max_fitness_iteration('Max Fitness Iteration: FlipFlop using RHC vs SA vs GA vs MIMIC-Small',
                                   array1=fit_rhc,
                                   array2=fit_sa, array3=fit_ga, array4=fit_mimic)
    plot_graph_fevals_iterations('FEvals vs Iteration: FlipFlop using RHC vs SA vs GA vs MIMIC-Small', array1=fevals_rhc,
                                  array2=fevals_sa, array3=fevals_ga, array4=fevals_mimic)
    plot_clock_time_table('Clock Time: FlipFlop using RHC vs SA vs GA vs MIMIC-Small', array1=clock_time_rhc,
